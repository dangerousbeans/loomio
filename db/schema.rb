...
ActiveRecord::Schema.define(version: 20151118022605) do
  ...
  add_index "group_measurements", ["age"], name: "index_group_measurements_on_age", using: :btree
  ...
  add_index "group_measurements", ["organisation_member_visits_count"], name: "index_group_measurements_on_organisation_member_visits_count", using: :btree
  add_index "group_measurements", ["organisation_visits_count"], name: "index_group_measurements_on_organisation_visits_count", using: :btree
